...
<head>
    ...
    <link rel="stylesheet" href="{!! asset('theme/material-design-icons/material-design-icons.css') !!}" type="text/css" />
...
<body>
    ...
    <div id="app" class="@guest noauth-bg @endguest">
        @auth
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                        @if (!count(Auth::user()->unreadNotifications))
                                            <li class="nav-item new-notification">
                                                <span class="dropdown-item break">Não há novas notificações.</span>
                                            </li>
                                        @else
                                            <li class="nav-item new-notification">
                                                @foreach (Auth::user()->unreadNotifications as $notification)
                                                    <a href="{{ route('posts.show', $notification->data['post']['id']) }}?cmd={{ $notification->data['comment']['id'] }}"
                                                        data-notif-id="{{ $notification->id }}" class="dropdown-item break">
                                        ...
                                        @endif
                                        <li class="nav-item new-notification p-1">
                                            <a href="{{ route('users.indexNotifications') }}"
                                                class="btn btn-primary w-100">Ver
                                                todas</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item"
                                            href="{{ route('password_change.edit', auth()->user()->id) }}">
                                            {{ __('Change Password') }}
                                        </a>
